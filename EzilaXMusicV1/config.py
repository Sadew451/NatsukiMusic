...
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/f3f7e2c4447bf96d4ea45.jpg")
admins = {}
...
PROJECT_NAME = getenv("PROJECT_NAME", "EzilaMusic V1")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/Sadew451/EzilaMusicV1")
